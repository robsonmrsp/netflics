...
define(function(require) {
	...
	var MultiselectModalLanguageTemplate = require('text!views/modalComponents/tpl/MultiselectModalLanguageTemplate.html');
	var Language = require('models/Language');
	


	var MultiselectModalLanguage = JSetup.View.extend({
		template : _.template(MultiselectModalLanguageTemplate),
		...
		initialize : function(opt) {
			var that = this;
			this.principalCollection = new  Language.PageClientCollection(opt.initialValues) ;

			this.modalCollection = new Language.PageCollection();
	...
	return MultiselectModalLanguage
});

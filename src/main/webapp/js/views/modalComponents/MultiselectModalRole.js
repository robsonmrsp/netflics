...
define(function(require) {
	...
	var MultiselectModalRoleTemplate = require('text!views/modalComponents/tpl/MultiselectModalRoleTemplate.html');
	var Role = require('models/Role');
	


	var MultiselectModalRole = JSetup.View.extend({
		template : _.template(MultiselectModalRoleTemplate),
		...
		initialize : function(opt) {
			var that = this;
			this.principalCollection = new  Role.PageClientCollection(opt.initialValues) ;

			this.modalCollection = new Role.PageCollection();
		...
		clearModal : function() {
			this.$el.find('input[type=checkbox]').prop('checked', false);
    		this.ui.inputModalAuthority.val(''),

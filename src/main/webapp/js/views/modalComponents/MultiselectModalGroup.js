...
define(function(require) {
	...
	var MultiselectModalGroupTemplate = require('text!views/modalComponents/tpl/MultiselectModalGroupTemplate.html');
	var Group = require('models/Group');
	


	var MultiselectModalGroup = JSetup.View.extend({
		template : _.template(MultiselectModalGroupTemplate),
		...
		initialize : function(opt) {
			var that = this;
			this.principalCollection = new  Group.PageClientCollection(opt.initialValues) ;

			this.modalCollection = new Group.PageCollection();

...
define(function(require) {
	...
	var MultiselectModalActorTemplate = require('text!views/modalComponents/tpl/MultiselectModalActorTemplate.html');
	var Actor = require('models/Actor');
	


	var MultiselectModalActor = JSetup.View.extend({
		template : _.template(MultiselectModalActorTemplate),
		...
		initialize : function(opt) {
			var that = this;
			this.principalCollection = new  Actor.PageClientCollection(opt.initialValues) ;

			this.modalCollection = new Actor.PageCollection();
		...
		clearModal : function() {
			this.$el.find('input[type=checkbox]').prop('checked', false);
    		this.ui.inputModalBirthDate.val(''),

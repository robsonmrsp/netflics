...
define(function(require) {
	...
	var MultiselectModalPermissionTemplate = require('text!views/modalComponents/tpl/MultiselectModalPermissionTemplate.html');
	var Permission = require('models/Permission');
	


	var MultiselectModalPermission = JSetup.View.extend({
		template : _.template(MultiselectModalPermissionTemplate),
		...
		initialize : function(opt) {
			var that = this;
			this.principalCollection = new  Permission.PageClientCollection(opt.initialValues) ;

			this.modalCollection = new Permission.PageCollection();
		...
		clearModal : function() {
    		...
    		this.ui.inputModalOperation.val(''),
    		this.ui.inputModalTagReminder.val(''),
	...
	return MultiselectModalPermission
});

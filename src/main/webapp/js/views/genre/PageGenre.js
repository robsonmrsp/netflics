...
define(function(require) {
	...
	var PageGenreTemplate = require('text!views/genre/tpl/PageGenreTemplate.html');

	var Genre = require('models/Genre');

	var PageGenre = JSetup.View.extend({
		template : _.template(PageGenreTemplate),
		...
		events : {
			'click 	.reset-button' : 'resetGenre',			
			'keypress' : 'treatKeypress',
			
			'click 	.search-button' : 'searchGenre',
		...
		initialize : function() {
			var that = this;
			this.genres = new Genre.PageCollection();
		...
		onShowView : function() {
			...
			this.dataTableGenreRegion.show(this.dataTableGenre);
		
			this.dataTableGenre.recoveryLastQuery();
		},
		
		 searchGenre : function(){		                                                                   
		 	var that = this;                                                                                                   
		 	this.dataTableGenre.getFirstPage({                                                                             
		 		success : function(_coll, _resp, _opt) {                                                                       
		 			//console.info('Consulta para o grid genre');                                         
		 		},                                                                                                             
		...
		getCellButtons : function() {
			...
			buttons.push({
				...
				type : 'primary',
				icon : 'fa-pencil',
				customClass : 'auth[edit-genre,disable]',
				hint : 'Editar Genre',
				onClick : that.editModel,
			}, {
				id : 'delete_button',
				type : 'danger',
				customClass : 'auth[delete-genre, disable]',
				icon : 'fa-trash',
				hint : 'Remover Genre',
		...
		deleteModel : function(model) {
			...
			var modelTipo = new Genre.Model({id : model.id});
		...
		editModel : function(model) {
			util.goPage("app/editGenre/" + model.get('id'));
		},

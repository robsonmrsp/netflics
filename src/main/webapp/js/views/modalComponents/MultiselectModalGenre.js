...
define(function(require) {
	...
	var MultiselectModalGenreTemplate = require('text!views/modalComponents/tpl/MultiselectModalGenreTemplate.html');
	var Genre = require('models/Genre');
	


	var MultiselectModalGenre = JSetup.View.extend({
		template : _.template(MultiselectModalGenreTemplate),
		...
		initialize : function(opt) {
			var that = this;
			this.principalCollection = new  Genre.PageClientCollection(opt.initialValues) ;

			this.modalCollection = new Genre.PageCollection();
